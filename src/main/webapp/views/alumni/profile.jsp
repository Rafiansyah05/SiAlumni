                                    ...
                                    <form action="${pageContext.request.contextPath}/alumni/profile" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="major" class="form-control" required>
                                                <option value="Teknik Informatika" ${user.major=='Teknik Informatika'
                                                    ? 'selected' : '' }>Teknik Informatika</option>
                                                <option value="Sistem Informasi" ${user.major=='Sistem Informasi'
                                                    ? 'selected' : '' }>Sistem Informasi</option>
                                                <option value="Manajemen Bisnis" ${user.major=='Manajemen Bisnis'
                                                    ? 'selected' : '' }>Manajemen Bisnis</option>
                                                <option value="Akuntansi" ${user.major=='Akuntansi' ? 'selected' : '' }>
                                                    Akuntansi</option>
                                                <option value="Teknik Elektro" ${user.major=='Teknik Elektro'
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="enrollment_year" class="form-control"
                                                value="${user.enrollmentYear}" required>
                                        </div>
                            ...
                            <div>
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <button onclick="openAddJob()" class="btn btn-gold"
                                            ...
                                            <tbody>
                                                <c:forEach var="job" items="${jobs}">
                                                    <tr data-id="${job.idJobExperience}"
                                                        ...
                                                        data-industri="${job.industri}" data-jabatan="${job.jabatan}"
                                                        ...
                                                        <td style="font-size: 14px;">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${not empty job.endDate}">
                                                                    <fmt:formatDate value="${job.endDate}"
                                                                        pattern="MMM yyyy" />
                                                                </c:when>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <button type="button" onclick="openEditJob(this)"
                                                                title="Edit"
                                                                style="background: none; border: none; color: var(--primary); cursor: pointer; margin-right: 8px;">
                ...
                <div id="modalJob"
                    ...
                    <div class="auth-card" style="max-width: 600px;">
                        <div
                            ...
                            <h3 id="modalJobTitle" style="font-weight: 800; color: var(--primary);">Tambah Riwayat
                                Pekerjaan</h3>
                            <button type="button" onclick="closeModalJob()"
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name" id="company_name_input" class="form-control"
                                        placeholder="Contoh: Google" list="companyList" autocomplete="off" required>
                                    <small style="color: var(--text-muted); font-size: 12px;">Ketik nama perusahaan,
                                        lalu pilih dari daftar yang muncul.</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="location" id="company_location_input" class="form-control"
                                        placeholder="Jakarta / Remote" required>
                                </div>
                            </div>
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Jabatan</label>
                                    <input type="text" name="jabatan" id="jabatan_input" class="form-control"
